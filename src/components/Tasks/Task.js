  ...
  const getTask = (id) => {
    TaskDataService.get(id)
      .then((response) => {
        setCurrentTask({
          ...response.data,
          ...((response.data?.taskType === undefined || null) && {
            taskType: "",
          }),
        });
      })
          ...
          <form>
            ...
            <div className="form-group">
              ...
              <input
                className="form-control"
                type="date"
                value={moment(currentTask.date).format("YYYY-MM-DD")}
                id="taskDate"
                name="date"
                onChange={handleInputChange}
              />
            ...
            <div className="form-group">
              <label htmlFor="taskType">
                Choose Task Type<sup className="text-center text-danger">*</sup>
                :
              </label>
              ...
              <select
                ...
                id="taskType"
              >
                <option selected={currentTask.taskType === ""} value="">
                  Select Task Type
                </option>
                <option
                  selected={currentTask.taskType === "Income Tax"}
                  key="type-1"
                  value="Income Tax"
                >
                  Income Tax
                ...
                <option
                  selected={currentTask.taskType === "GST"}
                  key="type-2"
                  value="GST"
                >
                  GST
                ...
                <option
                  selected={currentTask.taskType === "MCA"}
                  key="type-3"
                  value="MCA"
                >
                  MCA
                ...
                <option
                  selected={currentTask.taskType === "FEMA"}
                  key="type-4"
                  value="FEMA"
                >
                  FEMA
                ...
                <option
                  selected={currentTask.taskType === "DGFT"}
                  key="type-5"
                  value="DGFT"
                >
                  DGFT
                ...
                <option
                  selected={currentTask.taskType === "Others"}
                  key="type-6"
                  value="Others"
                >
                  Others
            ...
            <div className="form-group">
              <label htmlFor="billingCategory">
                Choose Billing Category
                <sup className="text-center text-danger">*</sup>:
              </label>
              ...
              <select
                ...
                id="billingCategory"
              >
                <option selected={!currentTask?.billingCategory} value="">
                  Select Billing Category
                </option>
                <option
                  selected={currentTask?.billingCategory === "Billable"}
                  key="billing-cat-1"
                  value="Billable"
                >
                  Billable
                ...
                <option
                  selected={currentTask?.billingCategory === "Non-Billable"}
                  key="billing-cat-2"
                  value="Non-Billable"
                >
                  Non-Billable
                ...
                <option
                  selected={currentTask?.billingCategory === "Retainer"}
                  key="billing-cat-3"
                  value="Retainer"
                >
                  Retainer
              ...
              <div className="form-group">
                ...
                <SearchableSelect
                  ...
                  onChange={(val) =>
                    setCurrentTask({
                      ...currentTask,
                      userId: val ? parseInt(val, 10) : currentTask.userId,
                    })
                  }
                />
              </div>
